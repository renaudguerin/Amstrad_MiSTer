...
three times on 2026-08-23: for the intended F6 Stage 1 behaviour change; for
the sampled-field expansion (holdoff latch + type-1 status flops added,
review issue 4 remediation — no RTL change); and for the intended type-1 F7
RFD behaviour. The F7 mint kept the seed, event schedule, and sampled-field
...
**`0xae27f2c3c758ed87`**. Two independent minting runs reproduced it and the
