...
module p10_dma_ppi_test_top (
	...
	(
		...
		.cclk_en_n(cclk_en_n),
		.hsync(hsync_i),
		// B8-5 slice A: no snapshot in this bench; apply payload ties off.
		.sna_load(1'b0),
		.sna_loop_cnt0(12'd0),
		.sna_loop_cnt1(12'd0),
		.sna_loop_cnt2(12'd0),
		.sna_loop_addr0(16'd0),
		.sna_loop_addr1(16'd0),
		.sna_loop_addr2(16'd0),
		.sna_pause_cnt0(12'd0),
		.sna_pause_cnt1(12'd0),
		.sna_pause_cnt2(12'd0),
		.sna_pause_presc0(8'd0),
		.sna_pause_presc1(8'd0),
		.sna_pause_presc2(8'd0),
		.sna_hsync(1'b0),
