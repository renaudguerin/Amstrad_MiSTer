...
| `sim/plus run/plus_p8_tests` | fast | `rtl/i8255.v` `rtl/plus/plus_sna_*.v` `rtl/plus/plus_fdc_decode.v` | Plus PPI quirks, SNA v3 Plus chunk parsing, FDC model gating |
