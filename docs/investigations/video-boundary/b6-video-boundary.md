...
The governing inputs are [D2](../hardware-runs/hardware-diagnosis-2026-09-10.md#d2--live-blanking-changes-ascals-acquisition-geometry)
and the [second-pass brief](../hardware-runs/hardware-diagnosis-2026-09-10-second-pass.md#b6-boundary-brief-for-the-next-session).
...
See the [hardware report](../hardware-runs/hardware-evidence-2026-09-12.md). B6 has not shown a
