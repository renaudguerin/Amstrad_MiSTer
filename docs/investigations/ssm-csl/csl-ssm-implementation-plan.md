...
[mister-hardware-loop-plan.md](../hardware-runs/mister-hardware-loop-plan.md) and the working B2 harness
recorded in [b2-device-capture-2026-09-12.md](../hardware-runs/b2-device-capture-2026-09-12.md). It is an
