...
[references/hardware-diagnosis-2026-09-10/](../../plus/archive/README.md):
...
- `OUTI ON C0vs=#3c` reads `01` (I/O on the 5th NOP) on the real CRTC 1
  ...
  [accc-author-feedback.md](../../classic/accc-author-feedback.md).
...
**Design inputs already on hand:** [b6-architecture-decision.md](../video-boundary/b6-architecture-decision.md)
