<!--
Converted from "8255 PPI.html" on 2026-08-26 using pandoc (HTML → GFM).
Note: 3 table(s) with rowspan/colspan were expanded to repeated cells to fit pipe tables.
...
| 6   | PSG databus | Read data from PSG or Write data to PSG |
| 5   | PSG databus | Read data from PSG or Write data to PSG |
| 4   | PSG databus | Read data from PSG or Write data to PSG |
| 3   | PSG databus | Read data from PSG or Write data to PSG |
| 2   | PSG databus | Read data from PSG or Write data to PSG |
| 1   | PSG databus | Read data from PSG or Write data to PSG |
| 0   | PSG databus | Read data from PSG or Write data to PSG |
...
| 6 | PSG BC1 | PSG function selection |
...
| 2 | Keyboard line | Select keyboard line to be scanned (0-15) |
| 1 | Keyboard line | Select keyboard line to be scanned (0-15) |
| 0 | Keyboard line | Select keyboard line to be scanned (0-15) |
