...
|---|---|---|
| `docs/screenshots/testing_0909/20260909_020052-...png` | Sky gradient has solid horizontal color bands; extreme 50 Hz frame flickering. | **Hazard 1 (B19 Residual)**: DMA acknowledge cycle clears `raster_fire` in `asic_ga_timing.v`. Lost PRI interrupt permanently halts the consecutive-line sky gradient chain for that frame. `[HYPOTHESIS - PENDING VERIFICATION]` |
