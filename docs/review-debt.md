...
**Status: all rows cleared 2026-08-24.** The
...
`docs/accuracy/f7-r0-widening-independent-review.md`. No row is outstanding; new unreviewed
work must open a fresh one per the rule at the bottom of this file.
