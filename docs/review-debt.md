...
**Status: all rows cleared 2026-08-25** (the `accuracy/f10-fixtures` row cleared by the Claude Opus 5 review + remediation; all earlier rows cleared 2026-08-24). The
