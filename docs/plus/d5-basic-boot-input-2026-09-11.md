...
**READY — local implementation, gates and fresh review complete.**
...
empty drive requires a later full-fit RBF and MiSTer retest. No merge, push or
synthesis is part of this task.
