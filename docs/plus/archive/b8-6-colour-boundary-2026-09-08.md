...
**Integrated from refreshed task tip `2bb75b5` on 2026-09-08.** The source-local
handoff and original gate/review evidence below predate integration. Combined
simulation, lint and Accuracy soak `0x6e8258198d6e6137` pass in the integration
checkout; CI/artifact status is reported separately in `docs/current-status.md`.
