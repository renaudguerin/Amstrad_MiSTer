...
The [September 9 SHAKER 2.7 retest](../investigations/hardware-runs/hardware-evidence-2026-09-09.md#shaker-capture-index)
includes A (T)/(4)/(U), B (1)/(9) and C (1) captures on CRTC1. A (T) and B (1)
remain defective. The [September 10 diagnosis](../investigations/hardware-runs/hardware-diagnosis-2026-09-10.md)
...
[B8 review](../investigations/write-timing/b8-architecture-methodology-review-2026-09-08.md) supplies a concrete
