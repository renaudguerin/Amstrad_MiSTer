...
**Plus B8-6 READY, 2026-09-08:** branch `codex/plus/b8-6-colour-alignment`,
...
refreshed integration gates belong to the coordinator and now expect Accuracy's
soak `0x6e8258198d6e6137`. Opus/high source review is CLEAR; the separately
...
and hardware/title retests. This branch is not integrated; no new RBF or
hardware verdict is claimed.
