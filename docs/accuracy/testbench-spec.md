...
| t02l-t02o type-0 natural VSYNC requires the preceding line to have reached C0=2; steady R0=1 consumes C4=R7 as blocked, while qualified exact-C0=0 writes to R0=0/1 retain the pulse and exercise the documented frozen/two-character outcomes — implemented, hardware validation pending | ACCC v1.11 English §16.4.1.2 pp.168-169, author-confirmed 2026-08-31 | Round-2 consequence audit |
...
All implemented groups are required passes. The classic suite currently has **189 required
