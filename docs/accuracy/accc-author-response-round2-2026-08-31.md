...
| §16.4.1.2 English p.169 | The two English-only R0/VSYNC paragraphs are normative and were intended to be added to French; their absence followed an update problem around §13.2.2. | Remove the “supplemental/unconfirmed” quarantine, but retain the English v1.11 page as the published anchor until a future French edition exists. Audit premise and vectors before any RTL change. |
