...
| **(O)** R1 STORIES | 8 | §17 pp.175–187, §17.6 pp.185–186 | **Pin behaviour implemented** (F6 Stage 1, 2026-08-23, `accuracy/a3-f6-stage1`, vectors t10a-t10e): type-0 border byte at C0=R0, type-1 absence, SKEW-DISPTMG displacement/suppression. **Stage 2 measured 2026-08-23** (`accuracy/f6stage2-soak-expand`, GA40010 co-sim render): visible seam 1 µs (16 mode-2 px), type 1 none — the recreation does not reproduce the book's 0.5 µs byte; see `accuracy/f6-decision-gate.md` Stage 2 section. SHAKER remains the hardware arbiter: compare the on-screen seam width against the Logon System photos before drawing conclusions. |
